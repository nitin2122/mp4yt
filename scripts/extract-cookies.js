 ...
 *
 * Usage:
 *   node scripts/extract-cookies.js <path-to-cookies.txt>
 *
 ...
 *   4. Run: node scripts/extract-cookies.js path/to/cookies.txt
...
║                                                              ║
║  Usage:                                                      ║
║    node scripts/extract-cookies.js <cookies.txt>             ║
║                                                              ║
║  Steps:                                                      ║
║    1. Install "Get cookies.txt LOCALLY" Chrome extension      ║
║    2. Log into YouTube with a BURNER Google account           ║
